...
```{r, message = FALSE, warning = FALSE, echo=FALSE}
plotRGB(r, r = 4, g = 3, b = 2, main = "R-G-B (natural color)")
plotRGB(r, r = 5, g = 4, b = 3, main = "NIR-R-G (fa)")
plotRGB(r, r = 6, g = 5, b = 4, main = "NIR-SWIR-R (false color water focus)")
plotRGB(r, r = 5, g = 7, b = 1, main = "NIR-SWIR2-Coastal aerosol (false color for vegetation and water)")
```

Applying stretch = "lin"
```{r, message = FALSE, warning = FALSE, echo=FALSE}
par(mfrow = c(2, 2))
plotRGB(r, r = 4, g = 3, b = 2, stretch = "lin", main = "R-G-B (natural color)")
plotRGB(r, r = 5, g = 4, b = 3, stretch = "lin", main = "NIR-R-G (fa)")
plotRGB(r, r = 6, g = 5, b = 4, stretch = "lin", main = "NIR-SWIR-R (false color water focus)")
plotRGB(r, r = 5, g = 7, b = 1, stretch = "lin", main = "NIR-SWIR2-Coastal aerosol (false color for vegetation and water)")
```

Applying stretch = "hist"
```{r, message = FALSE, warning = FALSE, echo=FALSE}
par(mfrow = c(2, 2))
plotRGB(r, r = 4, g = 3, b = 2, stretch = "hist", "R-G-B (natural color)")
plotRGB(r, r = 5, g = 4, b = 3, stretch = "hist", main = "NIR-R-G (fa)")
plotRGB(r, r = 6, g = 5, b = 4, stretch = "hist", main = "NIR-SWIR-R (false color water focus)")
plotRGB(r, r = 5, g = 7, b = 1, stretch = "hist", main = "NIR-SWIR2-Coastal aerosol (false color for vegetation and water)")
```
